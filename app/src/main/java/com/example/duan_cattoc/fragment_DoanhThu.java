...
public class fragment_DoanhThu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_fragment_doanh_thu, container, false);
        ...
        btnDoanhThu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HoaDonDAO phieuMuonDAO = new HoaDonDAO(getActivity());
                tvDoanhThu.setText("Doanh Thu: " + phieuMuonDAO.getDoanhThu(tuNgay, denNgay) + "K");
            }
        });
        return v;
    }
